...
//            System.out.println("parameters check OK");
        } catch (Exception e) {
            e.printStackTrace();
//            System.out.println("parameters check ERROR");
            return false;
        }
        // 验证证书
        try {
            licenseManager.verify();
//            System.out.println("parameters check success");
        } catch (Exception e) {
            e.printStackTrace();
//            System.out.println("parameters check fail");
            return false;
        }
        return true;
    }
